...
def make_beta_scan(folder_longnames):
...
if __name__ == "__main__":
    ...
    # make_beta_scan([make_scans.folder_name_dkh_explicit_betalr,
    #                 make_scans.folder_name_dkh_explicit_betalr_fbpar0,
    #                 make_scans.folder_name_dkh_implicit_betalr,
    #                 ])
    # make_beta_scan(make_scans.folder_name_dkh_explicit_betalr_fbpar0)
