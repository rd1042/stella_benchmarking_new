...
if __name__ == "__main__":
    ...
    postprocess_nonlinear_outnc_sim(folder_name + "/input_master_like_nonlinear_dt0002_fg_full_krange.out.nc")
    postprocess_nonlinear_outnc_sim(folder_name + "/input_master_like_nonlinear_dt001_fg_full_krange.out.nc")
