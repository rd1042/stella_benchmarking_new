...
kjm3_longname_src_h_explicit = "sims/kjm3_es_linear_master_src_h_comparison_higher_res/src_h_explicit"
kjm3_longname_src_h_implicit = "sims/kjm3_es_linear_master_src_h_comparison_higher_res/src_h_str_m_implicit"
kjm3_longname_src_h_implicit_zupw002 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res/src_h_str_m_implicit_zupw002"
kjm3_longname_src_h_implicit_tupw002 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res/src_h_str_m_implicit_tupw002"
kjm3_longname_src_h_implicit_zupw002_tupw002 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res/src_h_str_m_implicit_zupw002_tupw002"
kjm3_longname_master_explicit_ky35 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res_ky3.5/master_explicit"
kjm3_longname_master_implicit_ky35 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res_ky3.5/master_str_m_implicit"
kjm3_longname_src_h_explicit_ky35 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res_ky3.5/src_h_explicit"
kjm3_longname_src_h_implicit_ky35 = "sims/kjm3_es_linear_master_src_h_comparison_higher_res_ky3.5/src_h_str_m_implicit"
w003_longname_master_explicit_ky35 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky3.5/master_explicit"
w003_longname_master_implicit_ky35 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky3.5/master_str_m_implicit"
w003_longname_src_h_explicit_ky35 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky3.5/src_h_explicit"
w003_longname_src_h_implicit_ky35 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky3.5/src_h_str_m_implicit"
w003_longname_master_explicit_ky1 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky1/master_explicit"
w003_longname_master_implicit_ky1 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky1/master_str_m_implicit"
w003_longname_src_h_explicit_ky1 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky1/src_h_explicit"
w003_longname_src_h_implicit_ky1 = "sims/w003_es_linear_master_src_h_comparison_higher_res_ky1/src_h_str_m_implicit"

def kjm3_make_omega_t_plot_for_thesis_ky1():
    """ """
    sim_longnames = [
                    kjm3_longname_master_explicit,
                    kjm3_longname_master_implicit,
                    kjm3_longname_src_h_explicit,
                    # kjm3_longname_src_h_implicit,
                    # kjm3_longname_src_h_implicit_zupw002,
                    # kjm3_longname_src_h_implicit_tupw002,
                    kjm3_longname_src_h_implicit_zupw002_tupw002,
                        ]
    sim_labels = [
                 "master, explicit",
                 "master, implicit",
...
def kjm3_make_omega_t_plot_for_thesis_ky35():
    """ """
    sim_longnames = [
                kjm3_longname_master_explicit_ky35,
                kjm3_longname_master_implicit_ky35,
                kjm3_longname_src_h_explicit_ky35,
                kjm3_longname_src_h_implicit_ky35
                        ]
    sim_labels = [
                 "master, explicit",
                 "master, implicit",
    ...
    ax2.set_xlabel(r"$\tilde{t}$", fontsize=x_labelfontsize)
    # plt.show()
    plt.savefig("images/kjm3_master_src_h_omega_t.eps")
    plt.close()
    return

def kjm3_make_phi_z_plot_for_thesis_ky35():
    """ """
    ...
    #ax1.grid(True)
    plt.savefig("images/kjm3_master_src_h_comparison_phi_z.eps")
    plt.close()
    return

def w003_make_omega_t_plot_for_thesis_ky35():
    """ """
    sim_longnames = [
                w003_longname_master_explicit_ky35,
                w003_longname_master_implicit_ky35,
                w003_longname_src_h_explicit_ky35,
    ...
    ax1.set_ylim((0.37, 0.45))
    ax2.set_ylim((0.23, 0.29))
    ax3.set_ylim((0.23, 0.29))
    ...
    ax1.set_xticklabels([])
    ax2.set_xticklabels([])
    ax3.set_xticklabels(["-100", "-50", "0"], fontsize=x_ticklabelfontsize)
    ...
    ax3.set_ylabel(r"$\tilde{\gamma}_2$", fontsize=y_labelfontsize)
    ax3.set_xlabel(r"$\tilde{t}$", fontsize=x_labelfontsize)
    # plt.show()
    plt.savefig("images/w003_master_src_h_omega_t_ky35.eps")
    plt.close()
    return

def w003_make_phi_z_plot_for_thesis_ky35():
    """ """
    ...
    #ax1.grid(True)
    plt.savefig("images/w003_master_src_h_comparison_phi_z_ky35.eps")
    plt.close()
    return

def w003_make_omega_t_plot_for_thesis_ky1():
    """ """
    sim_longnames = [
                w003_longname_master_explicit_ky1,
                w003_longname_master_implicit_ky1,
                w003_longname_src_h_explicit_ky1,
    ...
    ax2.set_xlabel(r"$\tilde{t}$", fontsize=x_labelfontsize)
    # plt.show()
    plt.savefig("images/w003_master_src_h_omega_t_ky1.eps")
    plt.close()
    return

def w003_make_phi_z_plot_for_thesis_ky1():
    """ """
    ...
    #ax1.grid(True)
    plt.savefig("images/w003_master_src_h_comparison_phi_z_ky1.eps")
    plt.close()
    return
